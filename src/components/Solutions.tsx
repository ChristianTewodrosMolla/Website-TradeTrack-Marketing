...
const Solutions = () => {
  return (
    <section id="services-overview" className="section-spacing bg-[hsl(0_0%_99%)]">
      <div className="container mx-auto px-4 max-w-6xl">
        <Reveal>
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <div className="mt-6">
              <a href="/#services-overview" className="text-primary hover:text-primary/80 transition-colors font-medium">
                View all services
              </a>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {solutions.map((solution, index) => (
            <Reveal key={index} delay={index * 50}>
              <Card className="border-0 shadow-[var(--card-shadow)] hover:shadow-[var(--card-hover-shadow)] transition-shadow duration-300 h-full flex flex-col rounded-lg">
